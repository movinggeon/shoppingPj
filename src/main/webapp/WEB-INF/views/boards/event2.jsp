...
<body>
	이벤트 게시판 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
			...
			<c:forEach items="${eventboardlist}" var="event" begin="0" end="5">
				<li>
					...
					<div class="review_list_wrap">
						...
						<dl>
							<dt>
								<a href="/boards/readView?board_id=${event.board_id}"><c:out value="${event.board_content}" /></a>
							</dt>
							<dd>
								<a href="#"><c:out value="${event.board_title}" /> </a>
							</dd>
							<dd>
